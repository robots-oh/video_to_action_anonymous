...
def clean_keyframe(key_frame_idx_list, obj_world_pose,trans_threshold=0.05, rot_threshold=np.radians(20)):
    new_frame_idx_list = []
    ...
    for idx in range(1, len(key_frame_idx_list)): # ignore first and last frame
        cur_frame_idx = key_frame_idx_list[idx]
        far = check_pose_diff(
            obj_world_pose[prev_frame_idx], obj_world_pose[cur_frame_idx],
...
def collect_narr_function(poses_dict_list, lang, intermediate_frame_length=1):
    ...
    for _, poses_dict in enumerate(poses_dict_list):
        ...
        # get key frame idx
        #obj0_pose_relative_to_obj1_list = poses_dict["grasp_obj0_pose_relative_to_grasp_obj1"]
        #obj1_pose_relative_to_obj0_list = poses_dict["grasp_obj1_pose_relative_to_grasp_obj0"]
        #obj0_pose_to_obj1_seq_length = len(obj0_pose_relative_to_obj1_list)

        obj0_pose_in_world_list = poses_dict["grasp_obj0_pose"]
        obj1_pose_in_world_list = poses_dict["grasp_obj1_pose"]
        obj0_pose_seq_length = len(obj0_pose_in_world_list) # 1. 여기서 뽑힌거 length 비교해서 사진이랑 비교
        obj1_pose_seq_length = len(obj1_pose_in_world_list) 


        obj0_key_frame_idx_list = range(0, obj0_pose_seq_length, intermediate_frame_length)
        #print(f"obj0 keyframe_idx_list:{obj0_key_frame_idx_list}")
        obj1_key_frame_idx_list = range(0, obj1_pose_seq_length, intermediate_frame_length)
        #print(f"obj1 keyframe_idx_list:{obj1_key_frame_idx_list}")

        #keypoint_list = poses_dict["keypoint"]

        assert len(obj0_key_frame_idx_list) == len(obj0_pose_in_world_list)  
        assert len(obj1_key_frame_idx_list) == len(obj1_pose_in_world_list)

        obj0_key_frame_idx_list = clean_keyframe(obj0_key_frame_idx_list, obj0_pose_in_world_list)
        #print(f"obj0 keyframe:{obj0_key_frame_idx_list}")
        obj1_key_frame_idx_list = clean_keyframe(obj1_key_frame_idx_list, obj1_pose_in_world_list)
        #print(f"obj1 keyframe:{obj1_key_frame_idx_list}")
        key_frame_idx_list = sorted(list(set(obj0_key_frame_idx_list ) | set(obj1_key_frame_idx_list)))
        #print(f"{key_frame_idx_list}") # 2. 위에서 얻은 length를 이 idx list에 더하면 원래 frame
        ...
        for idx in range(len(key_frame_idx_list)-1):
            ...
            obj0_cur_state_in_world = poses_dict["grasp_obj0_pose"][cur_frame_idx]
            obj1_cur_state_in_world = poses_dict["grasp_obj1_pose"][cur_frame_idx]

            obj0_cur_state_next_in_world = poses_dict["grasp_obj0_pose"][next_frame_idx]
            obj1_cur_state_next_in_world = poses_dict["grasp_obj1_pose"][next_frame_idx]
            ...
            obj0_world_cur_action = calculate_action(obj0_cur_state_in_world, obj0_cur_state_next_in_world)
            obj1_world_cur_action = calculate_action(obj1_cur_state_in_world, obj1_cur_state_next_in_world)
        ...
        # add final frame
        cur_frame_idx = -1
        obj0_cur_state_in_world = poses_dict["grasp_obj0_pose"][-1]
        obj1_cur_state_in_world = poses_dict["grasp_obj1_pose"][-1]
        obj0_cur_state_next_in_world = obj0_cur_state_in_world
        obj1_cur_state_next_in_world = obj1_cur_state_in_world
...
def save_zarr(
        ...
        obj0_to_obj1_action_arrays,
        obj1_to_obj0_action_arrays,
    ...
    print(obj0_state_in_world_arrays.shape)
    print(obj1_to_obj0_state_arrays.shape)
    print(obj1_state_in_world_arrays.shape)

    print(obj0_to_obj1_state_next_arrays.shape)
    print(obj0_state_next_in_world_arrays.shape)
    print(obj1_to_obj0_state_next_arrays.shape)
    print(obj1_state_next_in_world_arrays.shape)
    print(obj0_to_obj1_action_arrays.shape)
    print(obj1_to_obj0_action_arrays.shape)
    print(obj0_world_action_arrays.shape)
    print(obj1_world_action_arrays.shape)
    ...
    for idx, episode_end_index in enumerate(episode_ends_arrays):
        ...
        obj0_state_in_world_array = obj0_state_in_world_arrays[episode_start_index: episode_end_index]

        obj1_to_obj0_cur_state_array = obj1_to_obj0_state_arrays[episode_start_index: episode_end_index]
        obj1_state_in_world_array = obj1_state_in_world_arrays[episode_start_index: episode_end_index]


        obj0_to_obj1_cur_state_next_array = obj0_to_obj1_state_next_arrays[episode_start_index: episode_end_index]
        obj0_cur_state_next_in_world_array = obj0_state_next_in_world_arrays[episode_start_index: episode_end_index]

        obj1_to_obj0_cur_state_next_array = obj1_to_obj0_state_next_arrays[episode_start_index: episode_end_index]
        obj1_cur_state_next_in_world_array = obj1_state_next_in_world_arrays[episode_start_index: episode_end_index]
        ...
        obj0_world_cur_action_array = obj0_world_action_arrays[episode_start_index: episode_end_index]
        obj1_world_cur_action_array = obj1_world_action_arrays[episode_start_index: episode_end_index]
        ...
        obj0_action_max = np.max(obj0_world_cur_action_array[:, :3], axis=0)
        obj0_action_min = np.min(obj0_world_cur_action_array[:, :3], axis=0)
        obj0_action_mean = np.mean(obj0_world_cur_action_array[:, :3], axis=0)
        obj0_action_range = obj0_action_max - obj0_action_min

        obj1_action_max = np.max(obj1_world_cur_action_array[:, :3], axis=0)
        obj1_action_min = np.min(obj1_world_cur_action_array[:, :3], axis=0)
        obj1_action_mean = np.mean(obj1_world_cur_action_array[:, :3], axis=0)
        ...
        obj0_state_max = np.max(obj0_state_in_world_array[:, :3], axis=0)
        obj0_state_min = np.min(obj0_state_in_world_array[:, :3], axis=0)
        obj0_state_mean = np.mean(obj0_state_in_world_array[:, :3], axis=0)
        obj0_state_range = obj0_state_max - obj0_state_min

        obj1_state_max = np.max(obj1_state_in_world_array[:, :3], axis=0)
        obj1_state_min = np.min(obj1_state_in_world_array[:, :3], axis=0)
        obj1_state_mean = np.mean(obj1_state_in_world_array[:, :3], axis=0)
        ...
        print(f"Episode {idx}: length {len(obj0_world_cur_action_array)}, action range {obj0_action_range}, progress range {progress_range}")
        print(f"Episode {idx}: length {len(obj1_world_cur_action_array)}, action range {obj1_action_range}, progress range {progress_range}")
    ...
    action_chunk_size01 = (100, obj0_to_obj1_action_arrays.shape[1])
    action_chunk_size10 = (100, obj1_to_obj0_action_arrays.shape[1])

    action_chunk_size0 = (100, obj0_world_action_arrays.shape[1])
    action_chunk_size1 = (100, obj1_world_action_arrays.shape[1])
    ...
    zarr_data.create_dataset('obj0_to_obj1_action', data=obj0_to_obj1_action_arrays, chunks=action_chunk_size01, dtype='float32', overwrite=True, compressor=compressor)
    zarr_data.create_dataset('obj1_to_obj0_action', data=obj1_to_obj0_action_arrays, chunks=action_chunk_size10, dtype='float32', overwrite=True, compressor=compressor)
    zarr_data.create_dataset('obj0_world_action', data=obj0_world_action_arrays, chunks=action_chunk_size0, dtype='float32', overwrite=True, compressor=compressor)
    zarr_data.create_dataset('obj1_world_action', data=obj1_world_action_arrays, chunks=action_chunk_size1, dtype='float32', overwrite=True, compressor=compressor)
