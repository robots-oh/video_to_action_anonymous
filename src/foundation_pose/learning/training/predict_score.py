...
class ScorePredictor:
  def __init__(self, amp=True):
    ...
    ckpt_dir = f'{project_root}/data/model_weight/foundation_pose/{self.run_name}/{model_name}'
    self.cfg = OmegaConf.load(f'{project_root}/data/model_weight/foundation_pose/{self.run_name}/config.yml')
