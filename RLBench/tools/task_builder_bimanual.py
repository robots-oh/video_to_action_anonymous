...
class LoadedTask(object):
    ...
    def record_demo(self):
        ...
        cam_motion = CircleCameraMotion(cam, Dummy('cam_cinematic_base'), 0.005, init_rotation=np.deg2rad(90))
        ...
        recording_output_path = f"/data/rlbench_video_{self.task_file[:-3]}.mp4" 

        tr.save(recording_output_path, f" ", 1 )
