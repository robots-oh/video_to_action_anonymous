...
class ObservationConfig(object):
    def __init__(self,
                 ...
                 wrist_left_camera: CameraConfig = None,
                 wrist_right_camera: CameraConfig = None,
        ...
        self.wrist_left_camera = (
            CameraConfig() if wrist_left_camera is None
            else wrist_left_camera)
        self.wrist_right_camera = (
            CameraConfig() if wrist_right_camera is None
            else wrist_right_camera)
        self.front_camera = (
    ...
    def set_all_high_dim(self, value: bool):
        ...
        self.wrist_left_camera.set_all(value)
        self.wrist_right_camera.set_all(value)
