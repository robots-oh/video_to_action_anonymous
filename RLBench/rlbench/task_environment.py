...
class TaskEnvironment(object):
    ...
    def __init__(self,
        ...
        # self._robot_shapes is handled in Scene class, so it is not needed here.
    ...
    def _get_live_demos(self, amount: int,
        ...
        for i in range(amount):
            ...
            # The following while loop is commented out because we will not be using random reset.
            # The environment should be reset by reset_to_demo before calling this function.
            while attempts > 0:
